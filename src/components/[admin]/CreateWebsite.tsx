...
export default function CreateWebsite() {
  const { mutate, isPending } = useWebsitesCreateMutation();
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="h-24 w-full resize-none rounded-xl border border-gray-200 bg-gray-50/50 px-4 py-2.5 text-sm transition-all focus:border-orange-500 focus:bg-white focus:ring-orange-500/10 focus:outline-none"
              />
            </div>
