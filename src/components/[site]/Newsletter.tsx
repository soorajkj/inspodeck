  ...
  return (
    <div className="relative w-full max-w-md">
      <div className="flex gap-px">
        ...
        />
        <Button className="relative inline-flex aspect-square h-10 shrink cursor-pointer items-center justify-center gap-2 rounded-none border border-transparent bg-orange-500 px-3 text-sm leading-none font-semibold whitespace-nowrap text-white hover:bg-orange-500 disabled:pointer-events-none disabled:opacity-90 [&_svg]:pointer-events-none [&_svg]:size-3.5 [&_svg]:shrink-0">
          Subscribe now
        </Button>
      </div>
